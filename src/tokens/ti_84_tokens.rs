...
pub fn get_ti_84_tokens() -> HashMap<u8, String> {
    let tokens: HashMap<u8, String> = [
        ...
        (0x13, "invT(".to_string()),
        (0x14, "\u{03c7}\u{00b2}GOF-Test(".to_string()),
        ...
        (0x30, "\u{25ba}n/d\u{25c4}\u{25ba}Un/d".to_string()),
        (0x31, "\u{25ba}F\u{25c4}\u{25ba}D".to_string()),
        (0x32, "remainder(".to_string()),
        (0x33, "\u{03a3}(".to_string()),
        (0x34, "logBASE(".to_string()),
        (0x35, "randIntNoRep(".to_string()),
        (0x36, "MATHPRINT".to_string()),
        (0x37, "CLASSIC".to_string()),
        (0x38, "n/d".to_string()),
        (0x39, "Un/d".to_string()),
        (0x3A, "AUTO".to_string()),
        (0x3B, "DEC".to_string()),
        ...
        (0x4C, "LTGREY".to_string()),
        (0x4D, "MEDGREY".to_string()),
        (0x4E, "GREY".to_string()),
        (0x4F, "DARKGREY".to_string()),
        ...
        (0x73, "tinydotplot".to_string()),
        (0x74, "Thin".to_string()),
        (0x75, "Dot-Thin".to_string()),
        (0x79, "PlySmth2".to_string()),
        (0x7A, "Asm84CEPrgm".to_string()),
        (0x81, "Quartiles Setting\u{2026}".to_string()),
